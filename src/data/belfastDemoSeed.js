...
export const BELFAST_DEMO_ISSUE_EXAMPLES = [
  {
    id: 'seed-note-city-hall',
    label: 'Tactile note',
    title: 'City Hall crossings',
    area: 'Donegall Square',
    detail: 'Seeded crossings include tactile paving, lowered kerbs, and at least one audible signal.'
  },
  {
    id: 'seed-note-grand-central',
    label: 'Difficult junction',
    title: 'Grand Central approach',
    area: 'Great Victoria Street',
    detail: 'Wide signalised crossings and bus movements are marked as caution points in the demo corridor.'
  },
  {
    id: 'seed-note-lanyon',
    label: 'Issue example',
    title: 'Lanyon Place bridge approach',
    area: 'East Bridge Street',
    detail: 'The seed data marks raised kerbs and missing tactile paving near the bridge approach.'
  },
  {
    id: 'seed-note-titanic',
    label: 'Tactile note',
    title: 'Titanic Quarter route',
    area: "Queen's Road",
    detail: 'Wide crossings are seeded with tactile paving and lowered kerbs near the SSE Arena and Titanic Belfast.'
  }
];

export const BELFAST_DEMO_ROUTE_CORRIDORS = [
  {
    id: 'grand-central-city-hall',
    endpoints: [
      { name: 'Belfast Grand Central Station', lat: 54.5946, lng: -5.9367 },
      { name: 'Belfast City Hall', lat: 54.5964, lng: -5.9300 }
    ],
    candidates: [
      {
        id: 'grand-central-city-hall-howard',
        label: 'Howard Street demo corridor',
        coords: [
          [54.5946, -5.9367],
          [54.5948, -5.9348],
          [54.5953, -5.9328],
      ...
      {
        id: 'grand-central-city-hall-bedford',
        label: 'Bedford Street demo corridor',
        coords: [
          [54.5946, -5.9367],
          [54.5940, -5.9345],
          [54.5949, -5.9309],
  ...
  {
    id: 'city-hall-lanyon-place',
    endpoints: [
      { name: 'Belfast City Hall', lat: 54.5964, lng: -5.9300 },
      { name: 'Lanyon Place Station', lat: 54.5951, lng: -5.9174 }
    ],
    candidates: [
      {
        id: 'city-hall-lanyon-market',
        label: "St George's Market demo corridor",
        coords: [
          [54.5964, -5.9300],
          [54.5960, -5.9275],
          [54.5959, -5.9230],
      ...
      {
        id: 'city-hall-lanyon-waterfront',
        label: 'Waterfront demo corridor',
        coords: [
          [54.5964, -5.9300],
          [54.5970, -5.9260],
          [54.5962, -5.9191],
  ...
  },
  {
    id: 'queens-city-hall',
    endpoints: [
      { name: "Queen's University Belfast", lat: 54.5844, lng: -5.9342 },
      { name: 'Belfast City Hall', lat: 54.5964, lng: -5.9300 }
    ],
    candidates: [
      {
        id: 'queens-city-hall-botanic',
        label: 'Botanic Avenue demo corridor',
        coords: [
          [54.5844, -5.9342],
          [54.5873, -5.9311],
          [54.5894, -5.9309],
      ...
      {
        id: 'queens-city-hall-dublin-road',
        label: 'Dublin Road demo corridor',
        coords: [
          [54.5844, -5.9342],
          [54.5864, -5.9340],
          [54.5886, -5.9322],
  ...
  {
    id: 'lanyon-titanic-belfast',
    endpoints: [
      { name: 'Lanyon Place Station', lat: 54.5951, lng: -5.9174 },
      { name: 'Titanic Belfast', lat: 54.6081, lng: -5.9097 }
    ],
    candidates: [
      {
        id: 'lanyon-titanic-queens-bridge',
        label: "Queen's Bridge demo corridor",
        coords: [
          [54.5951, -5.9174],
          [54.5982, -5.9171],
          [54.6018, -5.9142],
      ...
      {
        id: 'lanyon-titanic-sse',
        label: 'SSE Arena demo corridor',
        coords: [
          [54.5951, -5.9174],
          [54.5987, -5.9180],
          [54.6028, -5.9138],
...
function noteFromFeature(feature) {
  const tags = feature.tags || {};
  const detail = tags.demo_issue || tags.demo_note;
  if (!detail) return null;
  return {
    id: feature.id,
    label: tags.demo_issue ? 'Issue example' : 'Tactile note',
    title: tags.name || 'Belfast crossing note',
    area: tags.area || 'Belfast',
    detail
  };
}

export function getRouteDemoNotes(scoredRoute, limit = 4) {
  if (!scoredRoute) return BELFAST_DEMO_ISSUE_EXAMPLES.slice(0, limit);
  const notes = scoredRoute.near
    .map(noteFromFeature)
    .filter(Boolean);
  const combined = [...notes, ...BELFAST_DEMO_ISSUE_EXAMPLES];
